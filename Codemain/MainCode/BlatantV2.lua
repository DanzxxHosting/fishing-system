...
local fishing = {
    ...
    TotalFish = 0,
    Settings = {
        FishingDelay = 0.001,      -- Dikurangi dari 0.3 ke 0.05
        CancelDelay = 0.001,     -- Dikurangi dari 0.05 ke 0.01
        HookWaitTime = 0.001,      -- Dikurangi dari 0.30 ke 0.15
        CastDelay = 0.001,         -- Dikurangi dari 0.07 ke 0.03
...
RE_MinigameChanged.OnClientEvent:Connect(function(state)
    if fishing.WaitingHook and typeof(state) == "string" and string.find(string.lower(state), "hook") then
        ...
        task.spawn(function()
            ...
            RequestFishingMinigameStarted:InvokeServer(1, 0, tick())
