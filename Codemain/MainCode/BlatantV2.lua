...
local fishing = {
    ...
    TotalFish = 0,
    Settings = {
        FishingDelay = 0.07,      -- Dikurangi dari 0.3 ke 0.05
        CancelDelay = 0.03,       -- Dikurangi dari 0.05 ke 0.01
        HookWaitTime = 0.02,      -- Dikurangi dari 0.30 ke 0.15
        CastDelay = 0.27,         -- Dikurangi dari 0.07 ke 0.03
